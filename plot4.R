...
png("./BasePlot/plot4.png", width = 480, height = 480)
## Now display 4 charts
par(mfcol = c(2, 2))
plot(plotData$RDate, plotData$Global_active_power, type="l", main = "", xlab = "", ylab = "Global Active Power")
...
plot(plotData$RDate, plotData$Voltage, type="l", main = "", xlab = "datetime", ylab = "Voltage")
plot(plotData$RDate, plotData$Global_reactive_power, type="l", main = "", xlab = "datetime", ylab = "Global_reactive_power")
## close device
dev.off()
